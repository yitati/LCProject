...
// TODO - BAOBAO what if we have only 3 (workers and tasks)

// this is a 2D dp problem, suppose dp[i][k] is the minimum subarray sum of cutting nums[0, i] into k+1 pieces
// (cut k times)
// then we can get
